...
export class ChipGroupToolbarItem extends React.Component<ChipGroupToolbarItemProps, ChipGroupToolbarItemState> {
  ...
  render() {
    const { categoryName, children, className, isClosable, closeBtnAriaLabel, onClick, tooltipPosition } = this.props;
    if (React.Children.count(children)) {
      const renderChipGroup = (id: string, HeadingLevel: any) => (
        <ul className={css(styles.chipGroup, styles.modifiers.toolbar, className)} {...this.props}>
          <li>
